...
import { SpaceringCursorService } from 'src/services/spacering-cursor.service';
import { RainbowfluidCursorService } from 'src/services/rainbowfluid-cursor.service';
...
export class CursifyLayout implements OnInit, AfterViewInit, OnDestroy {
